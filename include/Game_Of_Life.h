...
public:
	...
	int NextLiveCells(int i, int j, Field& my_Field); // declaring a method that checks the number of live cells around each cell
	...
	void Start(int Height, int Width); // declaring the method that runs the program
